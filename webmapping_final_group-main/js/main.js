//insert code here!//declare map variable in global scope
var map;
...
/*function calcStats(data) {
    ...
    for (var City of data.features) {
        ...
        for (var year = Jan-19; year <= Jan-22; year += 1) {
            //get snowfall for current year
            var value = City.properties["Snow_" + String(year)];
            //add value to array
...
function getData(map){
    //load the data
    fetch("data/NetBorderXing.geojson")
